...
| 2026-06-12 | Docs | Skill file accuracy pass: fixed stale lifecycle.yml location (common→actions, 3 places in workflow-map.md + bonedigger.md), fixed dakota E2E "disabled" gap note (restored in #598). Ensures agents get correct answers without digging through history. | — |

---
name: bluefin-iso
description: Bluefin ISO building and promotion — use when building installation ISOs, promoting ISOs from testing to production in CloudFlare R2, or troubleshooting the ISO pipeline. Contains critical LTS warnings.
---
...
Load with: `cat ~/src/skills/bluefin-iso/SKILL.md`
...
- Changing image contents or packages — use `cat ~/src/skills/bluefin-build/SKILL.md`
- **LTS ISOs — DISABLED. Never build or promote LTS ISOs (see critical warning below)**
- CI failures unrelated to ISO promotion — use `cat ~/src/skills/bluefin-ci/SKILL.md`
...
bash ~/src/skills/bluefin-iso/scripts/promote-iso.sh VARIANT

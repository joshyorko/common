...
description: Bluefin security model — use when working with COPR repos, cosign verification, secureboot, or any security-sensitive package management decisions.
---
...
Load with: `cat ~/src/skills/bluefin-security/SKILL.md`
...
- Adding standard Fedora packages (no COPR) — use `cat ~/src/skills/bluefin-packages/SKILL.md`
- General build issues unrelated to signing or package isolation — use `cat ~/src/skills/bluefin-build/SKILL.md`
- ISO signing questions — use `cat ~/src/skills/bluefin-iso/SKILL.md`
